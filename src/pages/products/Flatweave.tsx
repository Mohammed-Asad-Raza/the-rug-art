...
import flatweave from "@/assets/flatweave-main.jpeg";
import craftsmanshipImage from "@/assets/craftsmanship.jpg";
import flatweave1 from "@/assets/flat-weave-1.jpg";
import flatweave2 from "@/assets/flat-weave-2.png";
import flatweave3 from "@/assets/flat-weave-3.jpg";
import flatweave4 from "@/assets/flat-weave-4.png";
import flatweave5 from "@/assets/flat-weave-5.jpg";
import flatweave6 from "@/assets/flat-weave-6.png";
import flatweave7 from "@/assets/flat-weave-7.jpg";
import flatweave8 from "@/assets/flat-weave-8.png";
import flatweave9 from "@/assets/flat-weave-9.jpg";
import flatweave10 from "@/assets/flat-weave-10.jpg";
import flatweave11 from "@/assets/flat-weave-11.jpg";
import flatweave12 from "@/assets/flat-weave-12.jpg";
import flatweave13 from "@/assets/flat-weave-13.jpg";
      ...
      <section className="py-5 bg-subtle-gradient">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <img
            ...
            height={650}
          />
          <h1 className="text-4xl md:text-5xl font-bold mb-6 pb-3 pt-10 text-gradient">
            Flatweave Rugs
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Discover our versatile flatweave collection, perfect for
            high-traffic areas with their durable construction and easy
            maintenance.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Explore our most sought-after Flatweave rug styles
            </p>
          </div>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 opacity-90">
            Discover our Flatweave collection and find the perfect rug for your
            space.
          </p>
        </div>
      </section>
